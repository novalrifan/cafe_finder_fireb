...
class OpeningHours extends Equatable {
  ...
  static List<OpeningHours> openingHoursList = const [
    OpeningHours(id: '1', day: 'Monday', openAt: 0, closeAt: 24, isOpen: false),
    ...
    OpeningHours(
        id: '6', day: 'Saturday', openAt: 0, closeAt: 24, isOpen: true),
    OpeningHours(id: '7', day: 'Sunday', openAt: 0, closeAt: 24, isOpen: true),
  ];
}
