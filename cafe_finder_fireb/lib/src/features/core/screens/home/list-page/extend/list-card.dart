                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Expanded(
                                      child: Text(
                                        widget.coffeeshops.locality == null
                                            ? widget.coffeeshops.localityVerbose
                                                .toString()
                                            : widget.coffeeshops.locality
                                                .toString(),
                                        style: tText.bodyText2!.copyWith(
                                ...
                                Text(
                                  // widget.coffeeshops.cFaciility.toString(),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                          '${widget.coffeeshops.distance!.toStringAsFixed(1)} m',
